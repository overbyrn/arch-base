...
echo en_US.UTF-8 en_GB.UTF-8 UTF-8 > '/etc/locale.gen'
locale-gen
...
curl --connect-timeout 5 --max-time 600 --retry 5 --retry-delay 0 --retry-max-time 60 -o /tmp/coreutils.tar.xz -L "https://github.com/overbyrn/arch-packages/raw/master/compiled/x86-64/coreutils.tar.xz"
...
curl --connect-timeout 5 --max-time 600 --retry 5 --retry-delay 0 --retry-max-time 60 -o /tmp/ncurses5-compat.tar.xz -L "https://github.com/overbyrn/arch-packages/raw/master/compiled/x86-64/ncurses5-compat-libs.tar.xz"
